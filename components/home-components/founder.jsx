    ...
    <section className="bg-white dark:bg-gray-900 py-16 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="relative w-full md:w-1/3 flex justify-center basis-1/2">
          {/* Background Accent */}
          <div className="absolute top-5 left-5 w-[95%] h-[95%] bg-purple-500 rounded-lg -z-10"></div>

          {/* Photo Card */}
          <div className="overflow-hidden rounded-lg shadow-lg transform transition-all duration-500 hover:scale-105 hover:rotate-1">
            <img

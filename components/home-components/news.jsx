      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#153151] dark:text-gray-100">
            Latest{" "}
            <span className="bg-gradient-to-r from-blue-600 to-blue-400 dark:from-gray-300 dark:to-gray-400 bg-clip-text text-transparent">
              News
            </span>
          </h2>
          <p className="mt-2 text-gray-600 dark:text-gray-300 text-base sm:text-lg">
            Stay updated with the latest updates from An-Nahdah
          </p>
        </div>
